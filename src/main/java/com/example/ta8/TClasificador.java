...
public class TClasificador {
    ...
    public static void main(String args[]) {
        ...
        System.out.print("Tiempo de ejecución: ");
        System.out
                .println(clasif.obtenerTiempoDeEjecucion(vectorDescendente.clone(), "METODO_CLASIFICACION_INSERCION"));
        ...
        System.out.print("Tiempo de ejecución: ");
        System.out
                .println(clasif.obtenerTiempoDeEjecucion(vectorDescendente.clone(), "METODO_CLASIFICACION_QUICKSORT"));
        System.out.println("altura: " + altura);
        ...
        System.out.println("___________________SELECCION______________________");
        System.out.println("ALEATORIO: ");
        System.out.print("Tiempo de ejecución: ");
        System.out.println(clasif.obtenerTiempoDeEjecucion(vectorAleatorio.clone(), "METODO_CLASIFICACION_SELECCION"));
        int[] resAleatorioE = clasif.clasificar(vectorAleatorio.clone(),
                METODO_CLASIFICACION_SELECCION);
        for (int i = resAleatorioE.length - 1; i >= 0; i--) {
            System.out.print(resAleatorioE[i] + " ");
        }
        System.out.println("");
        System.out.println("¿Está ordenado? " + estaOrdenado(resAleatorioE));
        System.out.println("ASCENDENTE: ");
        System.out.print("Tiempo de ejecución: ");
        System.out.println(clasif.obtenerTiempoDeEjecucion(vectorAscendente.clone(), "METODO_CLASIFICACION_SELECCION"));
        int[] resAscendenteE = clasif.clasificar(vectorAscendente.clone(),
                METODO_CLASIFICACION_SELECCION);
        for (int i = resAscendenteE.length - 1; i >= 0; i--) {
            System.out.print(resAscendenteE[i] + " ");
        }
        System.out.println("");
        System.out.println("¿Está ordenado? " + estaOrdenado(resAscendenteE));
        System.out.println("DESCENDENTE: ");
        System.out.print("Tiempo de ejecución: ");
        System.out
                .println(clasif.obtenerTiempoDeEjecucion(vectorDescendente.clone(), "METODO_CLASIFICACION_SELECCION"));
        int[] resDescendenteE = clasif.clasificar(vectorDescendente.clone(),
                METODO_CLASIFICACION_SELECCION);
        for (int i = resDescendenteE.length - 1; i >= 0; i--) {
            System.out.print(resDescendenteE[i] + " ");
        }
        System.out.println("");
        System.out.println("¿Está ordenado? " + estaOrdenado(resDescendenteE));
    }
}
